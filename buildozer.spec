...
requirements = python3,android,ledfx,qrcode

# (str) Custom source folders for requirements
# Sets custom source for any requirements with recipes
requirements.source.ledfx = deps/ledfx

# (str) Application versioning (method 1)
#version = 0.1

# (str) Application versioning (method 2)
version.regex = PROJECT_VERSION = ['"](.*)['"]
...
android.permissions = INTERNET, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, MODIFY_AUDIO_SETTINGS, RECORD_AUDIO, FOREGROUND_SERVICE, FOREGROUND_SERVICE_MEDIA_PLAYBACK, FOREGROUND_SERVICE_MEDIA_PROJECTION, CAMERA, REQUEST_INSTALL_PACKAGES, CAPTURE_AUDIO_OUTPUT, QUERY_AUDIO_STATE
...
android.manifest.intent_filters = %(source.dir)s/intent-filters.xml
